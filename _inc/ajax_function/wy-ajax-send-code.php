...
function wp_wy_send_code() {
	...
	ValidateParameter::validate_phone_number($phone_number);
    $verify_code = Helper::create_verification_code();
    $create_verify_code = new VerifyCodeDB();
    $create_verify_code->wy_creating_and_select_verification_code($phone_number,$verify_code);
    $send_sms = Sms::setter($create_verify_code,$phone_number,'121212');
