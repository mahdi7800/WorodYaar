...
class ValidateParameter
{
    ...
    public static function validate_verification_code($verification_code)
    {
    ...
    public static function validate_registration_system($full_name , $email , $password)
    {
    ...
    public static function validate_SignIn_system($username , $password)
    {
